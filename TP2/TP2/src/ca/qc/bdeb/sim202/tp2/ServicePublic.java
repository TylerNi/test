    ...
    void faireAction(Joueur joueur) {
        if(getProprietaire() == null){ //S'il n'y a pas de propriétaire, le joueur l'achète.
            if (joueur.getNombreArgent() >= getPrixAchat()) {
                ...
                System.out.println("\033[106m\033[38;2;255;105;180m" + joueur.getNom() + "a acheté " + nomCase + "pour " + this.getPrixAchat() + ". " + joueur.getNombreArgent() + "$ restant.");

            }else {
                System.out.println("\033[106m\033[38;2;255;105;180m" + joueur.getNom() + "n'a pas assez d'argent, il ne peut donc pas acheter " + nomCase);
            }
            ...
            System.out.println("\033[106m\033[38;2;255;105;180m" + joueur.getNom() + " a payé " + this.getLoyer() + "$ a " + getProprietaire() + ".");
            System.out.println("\033[106m\033[38;2;255;105;180m" + joueur.getNom() + " a maintenant " + joueur.getNombreArgent() + "$ et " + getProprietaire() + getProprietaire().getNombreArgent() + "$");

        }else {
            System.out.println("\033[106m\033[38;2;255;105;180m" + joueur.getNom() + "est propriétaire de " + nomCase + ". Il a" + joueur.getNombreArgent() + "$");
        }
    }
